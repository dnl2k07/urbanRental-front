                ...
                <div className="row">
                    ...
                    <div className="col-md-4 col-lg-3 mb-4 mb-md-0">
                        <img
                            ...
                            style={{ height: '60px', width: '180px' , borderRadius: '100px'}}
                            className="mb-3"
                        />
                    ...
                    <div className="col-md-2 col-lg-2 mb-4 mb-md-0">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li className="mb-2">
                                <Link to="/profile" className="text-white-50 hover-white text-decoration-none small">My Profile</Link>
                            </li>
                            <li className="mb-2">
                    ...
                    <div className="col-md-3 col-lg-4 mb-0">
                        ...
                        <div className="d-flex align-items-start gap-2 mb-3">
                            ...
                            <span className="text-white-50 small">+36 30 123 4567</span>
                        </div>
                        <div className="d-flex align-items-start gap-2">
                            
                            <span className="text-white-50 small">Debrecen, Piac utca 67</span>
                        </div>
                    </div>
                </div>
