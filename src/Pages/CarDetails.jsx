...
export default function CarDetails() {
    ...
    if (error) return <div className="alert alert-danger text-center mt-5 animate-fade-in">{error}</div>;
    if (!car) return <div className="alert alert-warning text-center mt-5 animate-fade-in">Car not found</div>;
        ...
        <div className={`page-transition-wrapper ${isVisible ? 'animate-fade-in-up' : ''}`}>
            <>
                ...
                <div className="container-fluid min-vh-100 pt-5 p-4">
                    <div className="row">
                        {/* Car Image */}
                        <div className={`col-md-6 mb-4 ${isVisible ? 'animate-fade-in-left' : ''}`}>
                            <div className="card shadow-sm border-0 animate-scale-in position-relative" style={{ height: '400px' }}>
                                <img
                                    src={currentImg}
                        ...
                        {/* Car Details */}
                        <div className={`col-md-6 ${isVisible ? 'animate-fade-in-right' : ''}`}>
                            <div className="card shadow-sm border-0 h-100 animate-scale-in">
